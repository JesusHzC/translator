package com.jesushzc.translator_kmm.android.voice_to_text.data
...
import com.jesushzc.translator_kmm.core.domain.util.toCommonStateFlow
import com.jesushzc.translator_kmm.voice_to_tex.domain.VoiceToTextParser
import com.jesushzc.translator_kmm.voice_to_tex.domain.VoiceToTextParserState
    ...
    override fun startListening(languageCode: String) {
        ...
        if(!SpeechRecognizer.isRecognitionAvailable(app)) {
            _state.update { it.copy(
                error = app.getString(R.string.error_recognition_not_available)
            ) }
            return
        }
